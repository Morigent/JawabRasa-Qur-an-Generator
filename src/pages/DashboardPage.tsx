...
export default function DashboardPage() {
  ...
  const remaining = Math.max(0, MAX_GENERATES - generateCount)
      ...
      >
        ...
        <section className="mb-stack-gap-sm flex justify-center animate-fade-in-up" style={{ animationDelay: '60ms' }}>
          ...
          >
            <span className="material-symbols-outlined" style={{ fontSize: 14 }}>
              {remaining > 0 ? 'auto_awesome' : 'error_outline'}
            </span>
            {remaining > 0
        ...
        <div className="flex flex-col gap-stack-gap-lg">
          ...
          <section className="animate-fade-in-up" style={{ animationDelay: '160ms' }}>
            <div className="flex justify-between items-end mb-stack-gap-sm">
              <h2
                className="text-primary"
              ...
              <a
                href="/reflect"
                onClick={(e) => { e.preventDefault(); navigate('/reflect') }}
                className="text-secondary hover:underline"
                style={{ fontFamily: 'Inter', fontSize: 10, fontWeight: 600, letterSpacing: '0.1em', textDecoration: 'none', cursor: 'pointer' }}
              >
                VIEW ALL
              </a>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {REFLECTIONS.map((r) => (
                <div
                  key={r.id}
                  className="bg-surface-container-lowest border border-outline-variant/20 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow"
                >
                  ...
                  <p
                    className="text-on-surface line-clamp-2 mb-2"
                    style={{ fontFamily: 'Inter', fontSize: 14, lineHeight: 1.5, fontStyle: 'italic' }}
                  >
                    {r.quote}
                  </p>
                  <p
